...
namespace LittleWhales.DB
{
    public interface IDatabaseQuery
    {
        ...
        Pager<TRet> Page<T1, T2, TRet>(Func<T1, T2, TRet> cb, long page, long itemsPerPage, string sql, params object[] args);
        Pager<TRet> Page<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, long page, long itemsPerPage, string sql, params object[] args);
        Pager<TRet> Page<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, long page, long itemsPerPage, string sql, params object[] args);
        ...
        Pager<TRet> Page<T1, T2, TRet>(Func<T1, T2, TRet> cb, long page, long itemsPerPage, Sql sql);
        Pager<TRet> Page<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, long page, long itemsPerPage, Sql sql);
        Pager<TRet> Page<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, long page, long itemsPerPage, Sql sql);
        ...
        Pager<T1> Page<T1, T2>(long page, long itemsPerPage, string sql, params object[] args);
        Pager<T1> Page<T1, T2, T3>(long page, long itemsPerPage, string sql, params object[] args);
        Pager<T1> Page<T1, T2, T3, T4>(long page, long itemsPerPage, string sql, params object[] args);
        IEnumerable<TRet> Query<TRet>(Type[] types, Delegate cb, Sql sql);
        Pager<TRet> Page<TRet>(Type[] types, Delegate cb, long page, long itemsPerPage, string sql, params object[] args);
        ...
        Pager<T1> Page<T1, T2>(long page, long itemsPerpage, Sql sql);
        Pager<T1> Page<T1, T2, T3>(long page, long itemsPerpage, Sql sql);
        Pager<T1> Page<T1, T2, T3, T4>(long page, long itemsPerpage, Sql sql);
